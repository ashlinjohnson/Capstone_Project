...
function Home() {
 ...
 const resources = [
  ...
  {
   title: "Credit Cards",
   description: "View credit card offers and manage balances.",
  ...
  <Box>
   ...
   >
    ...
    <Typography
     ...
     sx={{ mb: 2 }}
    >
     Commerce Bank Client Resources
    </Typography>
    ...
    <Typography
     ...
     sx={{ opacity: 0.9 }}
    >
     Access powerful financial tools, manage your accounts,
     and explore services designed to help you grow your future.
    </Typography>
